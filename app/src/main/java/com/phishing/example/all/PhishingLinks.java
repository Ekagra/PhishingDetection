...
public class PhishingLinks extends Fragment {
    ...
    private void setupList(){
        ...
        if(all_phishing.isEmpty()){
            text.setVisibility(View.VISIBLE);
        }else{
            //serialize
            links = new ArrayList<String>();
            String cList = sharedPref.getString("phishing_links", "");
            ...
            adapter = new LinksAdapter(mContext, R.layout.phishing_link, links);
